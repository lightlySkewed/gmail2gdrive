...
function getFolderByPath(path) {
  ...
  var folder = DriveApp.getFolderById('1wyYIgG4AZS-InCs3gvKZgx99mk2vxLP6');
...
function getOrCreateFolder(folderName) {
  ...
  try {
    ...
    folder = getOrCreateSubFolder(DriveApp.getFolderById('1wyYIgG4AZS-InCs3gvKZgx99mk2vxLP6'), folderArray);
  } catch(e) {
