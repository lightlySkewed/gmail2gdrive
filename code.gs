...
function getGmail2GDriveConfig() {
  return {
    ...
    // Processing rules:
    "rules": [
      { // Store all binder attachements from Jacob @ Superior to the 'Binders' folder in the Superior client folder
        "filter": "from:''Jacob Horton' via Sales' to:sales@triplecrownstl.com has:attachment filename:pdf",
        "folder": "'Binders from Gmail'",
        "filenameTo": "'%s - received 'MM-dd-yyyy'.pdf'"}
